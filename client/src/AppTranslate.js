...
export const tr = (txt, lang)=>{
  ...
  const translations = {
    ...
    Nav_SOFTWARE:{en:"Software Store", ua:"Магазин програм", pl:"Sklep programowy"},
    Nav_ELECTRONICS:{en:"Electronics Store", ua:"Магазин електроніки", pl:"Sklep elektroniczny"},
    Nav_SEABATTLE:{en:"Sea Battle", ua:"Морський бій", pl:"Morski bój"},
    Nav_OFFICE:{en:"Office", ua:"Офіс", pl:"Biuro"},
    Nav_OFFICEOLD:{en:"OfficeOld", ua:"ОфісСтарий", pl:"BiuroStare"},
    ...
    DocName_PS:{en:["Receipt", "Receipts"], ua:["Чек", "Чеки"], pl:["Paragon","Paragony"]},
    DocName_ZU:{en:["Tax","Taxes"], ua:["Податок","Податки"], pl:["Podatek","Podatki"]},
    DocName_VA:{en:["Tax","Taxes"], ua:["Податок","Податки"], pl:["Podatek","Podatki"]},
