...
function FinanceMonth({ props:{company, fi, taxYear, SAVE_MONTH, GET_DOCS, Reducer} }){
  ...
  return(
    <div className="FinanceMonth flex stretch wrap">
      ...
      { editDocs && <FinMonthDocs props={{company, fi, editDocs, setEditDocs, GET_DOCS, ON_CLICK, Reducer}}/> }
