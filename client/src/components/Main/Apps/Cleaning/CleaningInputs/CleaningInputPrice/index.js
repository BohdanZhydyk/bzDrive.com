...
import "./CleaningInputPrice.scss"

function CleaningInputPrice({ props: { val, legend, plhol, onChange, align } }) {
  ...
  return (
    <div className="CleaningInputPrice flex column">
...
export default CleaningInputPrice
