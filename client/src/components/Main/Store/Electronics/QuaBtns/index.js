...
function QuaBtns({ props:{QUA, qua, setQua} }){
  ...
  const minusStyles = {opacity: isQua ? 1 : 0.1}
  const plusStyles = {opacity: isMaxQua ? 1 : 0.1}
  ...
  return(
    <div className="QuaBtns flex end stretch">
    {
      ...
      ?
      <>
        <span className="QuaBtnMinus flex wrap" style={minusStyles} onClick={DECREASE_QUA}>
        ...
        <span className="QuaBtnPlus flex" style={plusStyles} onClick={INCREASE_QUA}>
