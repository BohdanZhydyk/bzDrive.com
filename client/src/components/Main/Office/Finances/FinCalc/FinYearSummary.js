...
export function FinYearSummary({ props:{lang, finances, taxPrevYear, GET_YEAR} }){
  ...
  const finInfo = [
    ...
    {txt:`Dochód firmy (netto) :`, val:`${calkulatedData.profit} zł`, cl:GrnRed(calkulatedData.profit)},
    {txt:`Dochód (bez VAT i ZUS) :`, val:`${calkulatedData.clearProfit} zł`, cl:GrnRed(calkulatedData.clearProfit)}
  ]
