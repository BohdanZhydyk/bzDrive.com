...
import { GetUser, bzCalc } from '../../../../../AppFunctions'
...
export function CalcLine({ props:{
  ...
  const vatText = "Podatnik zwolniony z VAT na podstawie art. 113 ust. 1 ustawy o VAT."
    ...
    <div className={`CalcLine ${top ? `` : `BorderBottom`} flex end stretch`}>
      ...
      <div className="CellsBetween flex end wrap stretch">
        ...
        <div className='CellsOne flex stretch'>
          ...
          { Bottom && isOK && <div className='VATZWtext flex start'>{vatText}</div> }
